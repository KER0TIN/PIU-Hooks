...
const std::list<ltekpad_mapping> ltek_binds = {
    {0, KEY_Q, STATE_PLAYER_1, PAD_LU},
    {1, KEY_E, STATE_PLAYER_1, PAD_RU},
    {4, KEY_S, STATE_PLAYER_1, PAD_CN},
    {2, KEY_A, STATE_PLAYER_1, PAD_LD},
    {3, KEY_D, STATE_PLAYER_1, PAD_RD},

	{5, KEY_R, STATE_PLAYER_2, PAD_LU},
    {6, KEY_Y, STATE_PLAYER_2, PAD_RU},
    {9, KEY_G, STATE_PLAYER_2, PAD_CN},
    {7, KEY_F, STATE_PLAYER_2, PAD_LD},
    {8, KEY_H, STATE_PLAYER_2, PAD_RD},
};
