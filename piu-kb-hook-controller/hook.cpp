...
const std::list<ltekpad_mapping> ltek_binds = {
    {0, "q", STATE_PLAYER_1, PAD_LU},
    {1, "e", STATE_PLAYER_1, PAD_RU},
    {4, "s", STATE_PLAYER_1, PAD_CN},
    {2, "z", STATE_PLAYER_1, PAD_LD},
    {3, "c", STATE_PLAYER_1, PAD_RD},
	
	{5, "r", STATE_PLAYER_2, PAD_LU},
    {6, "y", STATE_PLAYER_2, PAD_RU},
    {9, "g", STATE_PLAYER_2, PAD_CN},
    {7, "f", STATE_PLAYER_2, PAD_LD},
    {8, "h", STATE_PLAYER_2, PAD_RD},
};
